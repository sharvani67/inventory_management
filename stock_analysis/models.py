...
class Profile(models.Model):
    ...
    role = models.CharField(max_length=20, choices=[('admin', 'Admin'), ('owner', 'Owner'),('manager', 'Manager')])
...
class SellingPrice(models.Model):
    ...
    def __str__(self):
        return f"Price for {self.supplier_product.product_name} on {self.date_added}"
